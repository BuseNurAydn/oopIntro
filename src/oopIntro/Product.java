...
public class Product {
	private int id ; // tc kimlik no gibi ,kiþileri ayýrmak için
	private String name;      // adý
	private double unitPrice; // birim fiyatý
	private String details ;// açýklamalarý
	...
	public Product (int id,String name,double unitPrice,String details,
			double discount) {
		this();   // default constructoru çagýrmak için
		this.id=id;
		this.name=name;
